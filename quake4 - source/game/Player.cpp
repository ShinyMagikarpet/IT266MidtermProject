...
void idPlayer::UpdateConditions( void ) {
	...
	float	fallspeed;
	float	forwardspeed;
	float	sidespeed; //I added this
	float	verticalspeed; //I added this
