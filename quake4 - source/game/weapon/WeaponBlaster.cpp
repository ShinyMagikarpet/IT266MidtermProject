...
/*
================
rvWeaponBlaster::~rvWeaponBlastergun
================
*/
rvWeaponBlaster::~rvWeaponBlaster(void) {
	if (guideEffect) {
...
/*
================
rvWeaponBlaster::CancelGuide
================
*/
void rvWeaponBlaster::CancelGuide(void) {
	if (zoomGui && guideEnt) {
...
/*
================
rvWeaponBlaster::UpdateGuideStatus
================
*/
void rvWeaponBlaster::UpdateGuideStatus(float range) {
...
================
*/
void rvWeaponBlaster::OnLaunchProjectile(idProjectile* proj) {
...
stateResult_t rvWeaponBlaster::State_Fire ( const stateParms_t& parms ) {
	...
	switch ( parms.stage ) {
		case FIRE_INIT:	
			...
			if ( gameLocal.time - fireHeldTime > chargeTime ) {	
				Attack ( true, 1, spread, 0, 1.0f ); //(false, 1, spread, 0, 1.0f);
				PlayEffect ( "fx_chargedflash", barrelJointView, false );
				PlayAnim( ANIMCHANNEL_ALL, "chargedfire", parms.blendFrames );
			} else {
				Attack ( false, 1, spread, 0, 1.0f ); //(false, 1, spread, 0, 1.0f);
